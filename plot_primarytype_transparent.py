...
def main():
    ...
    for i in range(len(ptype)):
        ...
        plt.yticks([])
        plt.title(ptype[i])
        plt.savefig('heatmaps_transparent_' + ptype[i] + '.png',bbox_inches='tight')
